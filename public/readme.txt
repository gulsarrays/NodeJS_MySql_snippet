...
Step 4) update the DB credentails in config files 
			...
			for production environment, you have to create a new file as "production.json". Copy all the contents from development.json file and modify the DB credentails for production environment.
